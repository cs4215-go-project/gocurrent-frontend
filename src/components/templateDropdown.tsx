  ...
  return (
    <div className="relative text-md w-96 ml-12 inline-block justify-center text-left">
      <div className="bg-sky-500">
        <button type="button" className="bg-sky-500 inline-flex transition-transform duration-75 justify-left w-full dark:hover:text-gray-200 rounded-md hover:scale-95" id="options-menu" aria-haspopup="true" aria-expanded="true" onClick={() => setIsOpen(!isOpen)}>
          Templates
